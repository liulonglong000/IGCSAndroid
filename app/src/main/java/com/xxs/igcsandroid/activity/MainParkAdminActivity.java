...
import com.xxs.igcsandroid.fragment.SettingParkAdminFragment;
import com.xxs.igcsandroid.fragment.WeatherHistoryFragment;
import com.xxs.igcsandroid.fragment.WeatherParkAdminFragment;

public class MainParkAdminActivity extends MainBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_park_admin);
        ...
        switch(view.getId()){
            ...
            case R.id.menu_setting:
                ...
                if (fragment_setting == null){
                    fragment_setting = new SettingParkAdminFragment();
